...
export default function Footer() {
  ...
  return (
    <footer
      style={{
        backgroundColor: isDark ? "#090b10" : "#0f172a",
        color: "#94a3b8",
      }}
    >
            ...
            <div className="flex gap-2.5">
              {[
                ...
                <a
                  ...
                  onMouseEnter={(e) => ((e.currentTarget as HTMLAnchorElement).style.backgroundColor = "#6c3bf5")}
                  onMouseLeave={(e) => ((e.currentTarget as HTMLAnchorElement).style.backgroundColor = "#1e293b")}
                >
            ...
            <div className="space-y-5 text-sm">
              {[
                ...
                <div key={c.title}>
                  ...
                  <a href={`mailto:${c.email}`} className="text-[#00b4d8] hover:text-white text-xs transition-colors block">
                    {c.email}
                  </a>
                  {c.phone && (
                    <a href={`tel:${c.phone.replace(/\s/g, "")}`} className="text-slate-400 hover:text-white text-xs transition-colors">
                      {c.phone}
                    </a>
                  )}
                </div>
      ...
      <div style={{ borderTop: "1px solid #1e293b" }}>
        <div className="container-center py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-600">
